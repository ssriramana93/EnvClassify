#ifndef GALIB_PHOTOTAXIS_LOOP_FUNCTIONS_E_H
#define GALIB_PHOTOTAXIS_LOOP_FUNCTIONS_E_H


/* The NN controller */
#include <controllers/footbot_nn_test/footbot_nn_controller.h>
 ...
 *   O = number of outputs
 */
static const size_t GENOME_SIZE = 830;
