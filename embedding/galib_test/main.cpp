...
#include <loop_functions/galib_phototaxis_loop_functions_test/galib_phototaxis_loop_functions.h>
...
float LaunchARGoS(GAGenome& c_genome) {
   ...
   for(size_t i = 0; i < 5; ++i) {
      ...
      //  std::cout<<"Main "<<i<<" Size "<<cRealGenome[i]<<std::endl;
      }
...
int main(int argc, char** argv) {
   ...
   cSimulator.SetExperimentFileName("experiments/galib_test.argos");
